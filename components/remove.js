  ...
  return (
    <>
      <div className={`add-container ${props.rootClassName} `}>
        ...
        <div className="add-container05">
          <div className="add-container06">
            ...
            />
            <span className="add-text15">{props.text2}</span>
          </div>
          <div className="add-container15">
            <span className="add-text16">
      ...
      />
          ...
          <div className="add-container16">
            <span className="add-text17">{props.text5}</span>
            <span className="add-text18">{props.text6}</span>
            <div className="add-container17">
              <svg viewBox="0 0 1024 1024" className="add-icon09">
              ...
              <span className="add-text19">{props.text13}</span>
              <span className="add-text20">{props.text14}</span>
            </div>
          </div>
        </div>
      </div>
